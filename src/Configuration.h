...
// v4 C_NS(300), C_NS(750), C_NS(300) (80%)
// v5 C_NS(370), C_NS(580), C_NS(400)
class WS2815Controller : public ClocklessController<DATA_PIN, C_NS(370), C_NS(750), C_NS(350), RGB_ORDER> {};
